...
import vacationManagementHandler from "src/functions/vacation-management";
const isLocal = process.env.STAGE === "local";
const region = env.AWS_DEFAULT_REGION || "eu-north-1";
