...
const updateVacationHandler: APIGatewayProxyHandlerV2 = async (event) => {
  ...
  try {
    ...
    if (!vacationDays || typeof vacationDays !== "object" || Array.isArray(vacationDays)) {
      return {
        statusCode: 400,
    ...
    const unspentVacationDaysByYear = userAttributes.unspentVacationDaysByYear || [];
    ...
    userAttributes.unspentVacationDaysByYear = [...new Set(unspentVacationDaysByYear)];
